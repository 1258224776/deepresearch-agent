...
const dictionary = {
  zh: {
    ...
    input: {
      send: "发送",
      attachFiles: "添加附件",
      attachTooltip: "添加资料或代码",
      attachMenuTitle: "添加内容",
      attachMenuHint: "根据文件类型选择入口，上传后会自动加入当前对话。",
      attachDocument: "上传资料",
      attachDocumentHint: "支持 PDF、DOCX、TXT、MD、CSV",
      attachCode: "导入代码",
      attachCodeHint: "支持 PY、JS、TS、TSX、JSON、YAML、HTML、CSS、SQL",
      uploadingAttachments: "正在上传附件...",
      attachmentUploadFailed: "附件上传失败",
      attachmentsLimit: "最多只能上传 5 个附件",
    ...
    settings: {
      ...
      readOnly: "状态",
      editableTitle: "运行设置",
      editableHint: "这些项目可以修改，并保存在当前浏览器。",
      apiBase: "后端 API 地址",
      apiBaseHint: "指向 FastAPI 服务，例如 http://127.0.0.1:8000",
      chatEngine: "普通对话引擎",
      chatEngineHint: "可直接选择默认、引擎预设，或指定单个 provider。",
      researchEngine: "研究引擎",
      researchEngineHint: "用于 ReAct 研究模式，可直接选择预设或 provider。",
      plannerEngine: "规划引擎",
      plannerEngineHint: "用于 Planner 多步调查模式，可直接选择预设或 provider。",
      researchProfile: "研究 Skill Profile",
      researchProfileHint: "从后端已注册的 skill profile 中直接选择。",
      plannerProfile: "规划 Skill Profile",
      plannerProfileHint: "从后端已注册的 skill profile 中直接选择。",
      enginePresetGroup: "引擎预设",
      engineProviderGroup: "直连 provider",
      engineDefaultOption: "默认（后端自动）",
      engineDeepOption: "深度分析",
      engineFastOption: "极速直连",
      savedCustomOption: "已保存的自定义值",
      reset: "恢复默认",
      cancel: "取消",
      save: "保存设置",
      status: "当前连接",
  ...
  en: {
    ...
    input: {
      ...
      attachTooltip: "Add sources or code",
      attachMenuTitle: "Add attachments",
      attachMenuHint: "Choose the upload path that matches the file type. Uploaded files will be attached to this message.",
      attachDocument: "Upload document",
      attachDocumentHint: "Supports PDF, DOCX, TXT, MD, and CSV",
      attachCode: "Import code",
      attachCodeHint: "Supports PY, JS, TS, TSX, JSON, YAML, HTML, CSS, and SQL",
      uploadingAttachments: "Uploading attachments...",
      attachmentUploadFailed: "Attachment upload failed",
      attachmentsLimit: "You can attach up to 5 files.",
    ...
    settings: {
      ...
      readOnly: "Status",
      editableTitle: "Runtime settings",
      editableHint: "These fields are editable and saved to local browser storage.",
      apiBase: "Backend API URL",
      apiBaseHint: "Point to the FastAPI service, for example http://127.0.0.1:8000",
      chatEngine: "Chat engine",
      chatEngineHint: "Choose the default route, an engine preset, or a specific provider.",
      researchEngine: "Research engine",
      researchEngineHint: "Used for ReAct research mode. Choose a preset or direct provider.",
      plannerEngine: "Planner engine",
      plannerEngineHint: "Used for planner mode. Choose a preset or direct provider.",
      researchProfile: "Research skill profile",
      researchProfileHint: "Choose directly from the skill profiles registered by the backend.",
      plannerProfile: "Planner skill profile",
      plannerProfileHint: "Choose directly from the skill profiles registered by the backend.",
      enginePresetGroup: "Engine presets",
      engineProviderGroup: "Direct providers",
      engineDefaultOption: "Default (backend auto)",
      engineDeepOption: "Deep analysis",
      engineFastOption: "Fast route",
      savedCustomOption: "Saved custom value",
      reset: "Reset",
      cancel: "Cancel",
      save: "Save settings",
